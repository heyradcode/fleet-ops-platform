...
# =============================================================================
# Aurora auto-pauses to zero when idle, 14-day log retention, no deletion protection.
#
...
module "stack" {
  ...
  # Vite's preview server, so a developer can test the built bundle too.
  extra_callback_urls = ["http://localhost:4173/auth/callback"]

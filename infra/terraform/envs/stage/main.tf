...
# =============================================================================
# Production-shaped. The last place a bad plan can be caught before it matters.
#
...
module "stack" {
  ...
  # point maintaining SAML metadata for an environment CI destroys nightly.
  saml_metadata_url = "https://acme-test.example.com/FederationMetadata/2007-06/FederationMetadata.xml"
  oidc_issuer       = "https://acme.oktapreview.com/oauth2/default"
